...
export const postTestApi = (data?: any) =>
  request.post(Api.POST_TEST, data, { successMessage: true })

export const putTestApi = (data?: any) => request.put(Api.PUT_TEST, data)

export const deleteTestApi = (data?: any) =>
  request.delete(Api.DELETE_TEST, data, { errorMessage: false })

export const sameTestApi = (data?: any) =>
  request.get(Api.SAME_TEST, data, { cancelSame: true })

export const retryApi = (data?: any) =>
  request.get(Api.RETRY_TEST, data, { isRetry: true })
