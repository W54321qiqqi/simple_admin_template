...
import { getOS, getBrowse } from '/@/utils/navigator'
...
export const addOperationInfo = (data?: any) =>
  request.post(Api.ADD_OPERATION_INFO, data, { loading: false })

export const getOperationList = (data?: any) =>
  request.get(Api.GET_OPERATION_LIST, data, { loading: false })

export const addErrorInfo = (data?: any) =>
  request.post(Api.ADD_ERROR_INFO, data, { loading: false })

export const getErrorList = (data?: any) =>
  request.get(Api.GET_ERROR_LIST, data, { loading: false })
...
export const getLoginList = (data?: any) =>
  request.get(Api.GET_LOGON_LIST, data, { loading: false })
