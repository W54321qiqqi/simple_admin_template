<template>
  <base-page>
    <base-box
      ...
      :loading-full="full"
    >
      <base-button type="primary" @click="startCustomLoading(1)">
        v-custom-loading指令非全屏
      </base-button>
      <base-button type="primary" @click="startCustomLoading(2)">
        v-custom-loading指令全屏
      </base-button>
    </base-box>
    ...
    <base-box title="loading最小时长">
      ...
      />
      <base-button type="primary" @click="startTimeLoading">
        点击触发loading
      </base-button>
    </base-box>
  </base-page>
